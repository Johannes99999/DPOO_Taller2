...
import processamiento.Restaurante;
...
public class Aplicacion {
        ...
        do {
            ...
            switch (option) {
                case 1:
                    ...
                    break;
                case 2:
                    restaurant.startNewOrder(getClientName(), getClientAddress());
                    break;
                case 3:
    ...
    private static void printMenu() {
        System.out.println("Welcome to the Hamburger Shop!");
